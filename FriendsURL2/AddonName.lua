...
settings.FriendsURL2 = GetSetting("FriendsURL2");
...
function Init()
    ...
    AddonNameForm.RibbonPage = AddonNameForm.Form:GetRibbonPage("Google");
	...
	AddonNameForm.RibbonPage:CreateButton("Search ISxN", GetClientImage("Search32"), "SearchISxN", "Google");
	AddonNameForm.RibbonPage:CreateButton("Search Title", GetClientImage("Search32"), "SearchTitle", "Google");
	AddonNameForm.RibbonPage:CreateButton("Phrase Search", GetClientImage("Search32"), "SearchPhrase", "Google");
	AddonNameForm.RibbonPage:CreateButton("New URL", GetClientImage("Fraud32"), "NewURL", "AddonName");
	AddonNameForm.RibbonPage:CreateButton("My Favorite Site", GetClientImage("Fraud32"), "NewURL2", "AddonName");
...
function NewURL2()
		AddonNameForm.Browser:Navigate(settings.FriendsURL2);
